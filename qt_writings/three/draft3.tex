...
\subsection{sex}
\label{sec:org62b339c}
\subsubsection{section overview}
\label{sec:org0bc5c3e}
...
\subsection{skin}
\label{sec:org94ebb01}
\subsubsection{revision TODOs}
\label{sec:org968d473}
\begin{enumerate}
\item {\bfseries\sffamily DONE} SKIN: impose new schema
\label{sec:orgf356af3}
...
\item {\bfseries\sffamily TODO} SKIN: conclusion
\label{sec:orgc9181f2}
...
\item formal materiality, where abstraction engages manipulation and
sensuality, the shifting of registers.
\end{itemize}

--> like sex in \emph{Dawn}, makes sensual connections that blend feeling and
  thought.
\begin{itemize}
\item What Snorton says about the reduction to flesh. Such a reduction
...
\label{sec:orgd9c5595}
\begin{enumerate}
\item intro
\label{sec:org71d8bed}
...
\item {\bfseries\sffamily TODO} reduction of the black body
\label{sec:org965345b}
...
\label{sec:org5066971}

\begin{enumerate}
\item haptics
\label{sec:org470128e}
