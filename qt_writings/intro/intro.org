...
** Performativity
*** McGann, Bode, Clement
Such are the constraints of text analysis. But these are not reasons
to avoid it. In fact, being aware of the constraints, and working
within or against them, can be productive and enlightening. Literary
scholars working in digital methods have long been addressing
computational constraints, particularly in the field of textual
scholarship, which offers informative examples of different approaches
for handling text as data. Specifically, the work of Jerome McGann,
Katherine Bode, and Tanya Clement offers a way of thinking about data
that is /performative/ rather than representative. Their methodology
opens a space for digital humanists in literary studies for how to
work within (and resist) the constraints of computational processes.

Computational constraints can work with human ones, specifically, the
limitation of the reader's attention span. Underwood's project to
grasp a "distant horizon" of literary history is one attempt to
overcome this deficiency. Underwood sets up an opposition between
computer and human reading: "Computational analysis... is still quite
crude compared to human reading; it helps mainly with questions where
evidence is simply too big to fit in a single reader's memory"
(xxi). But his focus on the "distant horizon" in actuality blocks out
the ways that quantitative literary analysis, or distant reading, can
work in coordination with existing human deficiencies for
attention. What the computer properly does is arrange a set of
data--of any size--for human consumption. This involves processing
datasets into new forms and configurations that can then be scrutinzed
by a human reader. Quantitative methods can supplement human memory by
approaching memory, specifically working memory, as a resource, rather
than a hindrance. The computer can re-arrange text in a way that
focuses the attention span of the reader on elements previously unseen
or overlooked.

Jerome McGann's work as a eletronic textual editor is all about using
computational constraints effectively to harness human attention. In
transforming literary material into computable form, McGann takes the
...
with Lisa Samuels, describe literary interpretation as "deformance."
Deformance works by estranging the reader from her familiarity of the
text, forcing her to encounter the text in a new way. Deformative
analysis enables a volitality of meaning by subscribing each textual
to a new configuration. A popular example is reading a poem backward,
where “the critical and interpretive question is not 'What does the
poem mean?'  but 'How do we release or expose this poem’s
possibilities for meaning?'" (2001, 108). A "deformative criticism"
therefore distorts, disorders, or re-assembles literary texts to
discover new insights about its formal significance and meaning.

For McGann, the technical experience of editing electronic texts
enables potentialities of textual meaning. McGann introduces the term
“quantum poetics” to indicate the potential for meaning contained in
each element of a literary text. He explains that, “Aesthetic space is
...
inherent potentialities by carving new paths across familiar texts.

Katherine Bode builds off McGann's ideas about deformance to present a
/performative/ approach for working with electronic text. Bode
incorporates insights from Karen Barad's feminist scientific
interventions in theoretical physics [fn:15] to demonstrate that the
researcher is always implicated in the object of study. Barad's thesis
argues that objects in the world do not precede their actions, but
rather, 'objects' emerge through particular "intra-actions" (Barad
58). Bode brings Barad's point from theoretical physics to
computational modelling, explaining that "entities don’t pre-exist
engagements but are generated in an ongoing or emergent way, by those
intra-actions" ("Data Beyond Represenation" par. 2). In practice, this
means that rather than attempt to secure a factual or objective status
of the data, literary scholars should double down on the material
processes of using their tools. For Bode, what statisticians value as
...
Bode's research finds that an attention to the "apparatus," or the
instrument of analysis, is crucial in exploring the performative
aspects of inquiry. In troubling the subject/object boundary,
examining "how... we inscribe the boundaries we often presume to
represent," Bode offers an example with her current project, /Reading
at the Interface/, which explores the ways that Australian literature
has been characterized by various "paratexts," or "writings about
literature." ("Data Beyond Representation par 11.) The project
explores paratexts across various platforms, including academic
journals, newspapers, /Goodreads/, and /Librarything/, to see how they
have represented the boundary of "Australian Literature." Bode looks
at how the process of data collection makes a distinction between the
main text and the "paratext," or the metadata like title, author, and
publication information of the text. She is interested in how her
inquiry literally creates boundaries of what we understand to be
"text" and "paratext" in Australian literature. This activity
indicates, for Bode, how the researcher is intevening with the object
of analysis. Bode explains that she's "not interested in representing
...
[her] categories of analysis" ("Data Beyond Representation"
par. 19). Drawing from a physics understanding, where "an apparatus is
...
Tanya Clement's work with sound incorporates embodied play and
visualization toward a theory of performative criticism. She uses
figures and methods from audio analysis to reconsider the ways we
...
Human attention spans, rather than represent the hurdle for
computational methods to overcome, offer an opportunity for
re-imagining analysis as a process of deforming what we pay attention
to. As McGann speculates, engaging with texts on a computer could be
as intimate a process as engaging with them on paper. We might use
digital tools as “prosthetic extension of that demand for critical
reflection,” with which the reader is able to feel her way through the
text (18). The emphasis shifts from viewing text as something stable
and self-evident to something dynamic and subject to different
readings. The unique affordance of digital environments, according to
McGann, Bode and Clement, is that they allow for numerable
interventions upon the textual object. Like a musical score, which
"point[s] toward many possible interpretive 'results' or readings,"
visualizaions can provide a starting ground for different pathways of
analysis ("Distant Listening" par. 12). The above authors approach
computation as an opportunity to examine the material specificities of
eletronic formats.
