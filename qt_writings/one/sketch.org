...
- touch as a reading method: abstracting the senses for connection
  - touch as an intersection for queerness and DH
- the state of queerness as untouchable, not fully grasped
...
digital. Digital and Queer both abstract that which is untouchable
into sensual forms. 

Queerness can be defined as /a desire for touch/ that is
frustrated. Yet in being frustration, it opens other avenues of
connection (Confessions).  

The digital shows how frustration works at the level of narrative (Waves).
