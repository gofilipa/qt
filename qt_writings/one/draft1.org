...
confines of the normative.[fn:4] Both queer and digital are out there,
...
*** TODO add klein and d'ignazio on the rhetoric of images
...
reproduce our own assumptions? The answer is that we cannot. Indeed,
the answer is that /we do not want to/. As any person who has been
subjected to a minoritarian position already knows, we can never get
totally outside our own frame of reference. Objectivity is a white
illusion that colonizes the humanities. Our questions will always
already determine the answers. And we wouldn't have it any other
way. Why? because the supposition that some truth lies out there
waiting to be revealed is at best tedious, at worst dangerous, and as
Sedgwick points out, wouldn't do to solve the problems we have now:
"Supposing we were ever so sure... what would we know then that we
don't already know?" (123).  
...
insinuation in /reproducible/ that somehow these analyses exist by
themselves, outside of the critic.

*** illusion of emotional detachment 
...
** Abstraction: Moving to making new connections. 
...
** interweaving different digital reading styles
...
** Misc: data reduction / queer assimilation 
