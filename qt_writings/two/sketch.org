...
*** brainstorm
Perhaps the intervention here is about containment & queerness as
something irresolvable. Queerness is not something that can be
contained with certain markers. 
...
Queer Historicist debate about whether queerness is something that can
be known in in the past. Different approaches, the "yes it can" or "no
it cannot". Heather Love reframes this question--it becomes about
"affective history"--to what is the manner of the relationship between
queer critics and the subjects they study. Love's position is that we
will always attempt to rescusitate the queer, but that this is a
project doomed to fail. 

We might take this as inspiration in using TEI--using markup not to
demarcate, but to point to moments where queerness eludes our grasp. 

Applying McGann's idea of /deformance/, we might reconsider how our
attempts to rescusitate the queer creates new forms of queerness. 
